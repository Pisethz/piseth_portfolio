  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between gap-4 flex-wrap mb-8">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-primary mb-2 animate-fade-in">
            06 — Projects
          </p>
      ...
      {projects.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, i) => (
            <Card key={project.id} className="group flex flex-col hover-glow border-border/60 overflow-hidden animate-fade-up" style={{ animationDelay: `${0.05 + i * 0.08}s` }}>
