import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CrHL9HDt.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BC-AOYsC.mjs");
