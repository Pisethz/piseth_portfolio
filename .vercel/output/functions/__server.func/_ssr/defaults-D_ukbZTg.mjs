//#region node_modules/.nitro/vite/services/ssr/assets/defaults-D_ukbZTg.js
var defaultProfile = {
	name: "Chan Piseth",
	title: "IT Support Specialist & Developer",
	tagline: "Full-stack developer, IoT builder, and IT support specialist crafting reliable systems from Cambodia.",
	...
	about: {
		...
		address: "Gambel Village, Gambel Commune, Serey Sophon Town, Banteay Meanchey",
	...
	experiences: [
		...
		},
		{
			...
			company: "Union Tower",
			location: "Poi Pet, Cambodia",
			bullets: ["Provided IT support and officer duties", "Developed and maintained databases"]
		},
		{
			id: "exp-3",
			period: "2022 – 2024",
